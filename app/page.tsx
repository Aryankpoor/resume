            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Aryan
                  <br />
                  <span className="text-muted-foreground">Kapoor</span>
                </h1>
              </div>

              <div className="space-y-6 max-w-md">
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  College Sophomore and aspriring Software Engineer with experience in
                  <span className="text-foreground"> Desktop</span><span className="text-foreground"></span>,
                  and
            ...
            <div className="lg:col-span-2 flex flex-col justify-end space-y-6 sm:space-y-8 mt-8 lg:mt-0">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="text-foreground">Hardware Engineer</div>
                  <div className="text-muted-foreground">@ HackClub VIT Chennai, India</div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["C/C++", "Java", "React", "Python", "Node.js"].map((skill) => (
                    <span
                      key={skill}
              ...
              {[
                {
                  ...
                  description: "",
                  tech: ["Arduino", "RaspberryPi", "Digital Electronics"],
                },
                {
                  year: "2024",
                  role: "Junior Onboarder",
                  company: "The Hack Foundation | HCB",
                  description: "Built performant interfaces for project management and team collaboration.",
                  tech: ["Airtable", "Automations", "Banking"],
                },
                {
                  year: "2024",
                  role: "Volunteer Summer Reviewer",
                  company: "The Hack Foundation",
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  >
                    <span className="text-base sm:text-lg">email@email.coms</span>
                    <svg
